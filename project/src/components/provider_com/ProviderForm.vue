  ...
  <div class="card">
    ...
    <div class="form-grid">
      <div class="form-field">
        ...
        <input v-model="provider_name" type="text" :readonly="!editing" placeholder="Enter your name" />
      </div>
      <div class="form-field">
        <label>Farm Name</label>
        <input v-model="farm_name" type="text" :readonly="!editing" placeholder="Enter farm name" />
      </div>
      <div class="form-field">
      ...
      <div class="form-field">
        ...
        <input :value="store.provider.user_id" type="text" readonly class="readonly-input" />
      </div>
      <div class="form-field full">
        <label>Farm Story</label>
        <textarea v-model="story" :readonly="!editing" placeholder="Tell customers about your farm..." />
      </div>
    </div>

    <div class="edit-btns">
      <button v-if="!editing" class="btn-primary" @click="startEdit">Edit</button>
      <template v-else>
