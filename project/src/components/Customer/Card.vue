      ...
      <div class="card-body">
        ...
        <div class="price-row">
          <div class="prices">
            ...
            <span v-if="product.discount > 0" class="original-price">${{ formatPrice(product.originalPrice) }}</span>
          </div>
...
const normalizeProduct = product => {
  ...
  const finalPrice = discountVal > 0 ? +(basePrice * (1 - discountVal / 100)).toFixed(2) : basePrice
