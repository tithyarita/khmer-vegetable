...
<template>
  <div class="scene">
    ...
    <div class="card">
      ...
      <p class="subtext">Enter your email or phone number to receive a reset link.</p>
        ...
        <div class="field">
          ...
          <div class="input-wrap">
            ...
            <input
              ...
              v-model="contact"
              type="text"
              placeholder="you@example.com or +855 12 345 678"
              autocomplete="off"
      ...
      <p class="back-row">
        <a href="#" @click.prevent="router.push('/login')">&larr; Back to Login</a>
      </p>
    </div>
  </div>
</template>
...
async function handleSubmit() {
  ...
  try {
    await axios.post('http://localhost:3000/auth/forgot-password', payload)
...
.success-wrap strong { color: var(--text-dark); }
