<template>
  <div class="scene">
    ...
    <div class="card">
      ...
      <p class="subtext">Enter your new password.</p>
      ...
      <div class="form-wrap">
        ...
        <button class="btn-login" :disabled="loading" @click="handleReset">
...
async function handleReset() {
  ...
  try {
    ...
    error.value = e.response?.data?.message || 'Failed to reset password. Try again.'
  } finally {
    loading.value = false
  }
}
